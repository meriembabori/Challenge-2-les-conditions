...
(mot_de_passe.length>=8 &&  mot_de_passe.includes(nbr) && mot_de_passe.includes(caractere)){
console.log("Fort");}
else
    { console.log("Moyen");}
...
let nombre2=prompt("Entrer un nombre");
if(nombre2 % 3==0)
    {
console.log("FIZZ");
}
...
{
console.log("Buzz");
}else if (nombre2 %3==0 && nombre2 %5==0)
{console.log("FizzBuzz");}
else
   { console.log(nombre2);}
//challenge10:Système de connexion
let user_name=prompt("Saisir user name");
let mot_depasse=prompt("Saisir ton mot de passe");
if (user_name=="admin"&&mot_depasse=="1234")
{ console.log("Bienvenue Admin");
}
else if (user_name=="admin"&&mot_depasse!=="1234")
