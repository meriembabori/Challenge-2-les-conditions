...
let Nom1=prompt("Entrer votre nom ");
let Prenom1=prompt("Entrer votre prenom ");
let age1=prompt ("Entrer votre age");
let sex1=prompt("Entrer votre sex");
let Adress1= prompt ("Entrer votre adress");
console.log("le Nom est :",Nom1);
console.log("Le prenom est :",Prenom1);
console.log("L'age est :",age1);
console.log("le sex est :",sex1);
console.log("l'adress est :",Adress1);
